...
public class ComputadorDAOMySQL implements ComputadorDAO {
    ...
    private String updateSQL = "UPDATE computador SET marca=?, processador=?, quantidade de ram=?, tamanho do disco=? WHERE id=?";
    ...
    public List<Computador> read() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                computador.setQuantidade_de_ram(rs.getInt("quantidade de ram"));
                computador.setTamanho_do_disco(rs.getInt("tamanho do disco"));
